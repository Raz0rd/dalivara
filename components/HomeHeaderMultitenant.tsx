...
export default function HomeHeaderMultitenant({ onReviewsClick }: HomeHeaderProps) {
  const tenant = useTenant();
  
  // Dividir o nome da loja em duas linhas
  const storeNameParts = tenant.storeName.split(' ');
          ...
          <div className="relative h-full flex items-center justify-between px-4 py-4 gap-2">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="flex flex-col">
                <span 
                  className="text-white font-bold text-xl sm:text-2xl tracking-wide drop-shadow-lg"
